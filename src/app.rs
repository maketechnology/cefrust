...
unsafe extern "C" fn on_context_initialized(self_: *mut cef::_cef_browser_process_handler_t) {
...
#[allow(unused)]
unsafe extern "C" fn on_before_child_process_launch(self_: *mut cef::_cef_browser_process_handler_t,
                                                                                   command_line:
...
#[allow(unused)]
unsafe extern "C" fn on_render_process_thread_created(self_: *mut cef::_cef_browser_process_handler_t,
                                                                                     extra_info:
                                                                                         *mut cef::_cef_list_value_t) {
    debug("on_render_process_thread_created")
}

unsafe extern "C" fn get_print_handler(self_: *mut cef::_cef_browser_process_handler_t)
                                                     ->
...
#[allow(unused)]
unsafe extern "C" fn  on_schedule_message_pump_work(self_: *mut cef::_cef_browser_process_handler_t,
                                                                                  delay_ms: cef::int64) {
...
unsafe extern "C" fn get_resource_bundle_handler(self_: *mut cef::_cef_app_t)
                                                               ->
...
unsafe extern "C" fn get_browser_process_handler(self_: *mut cef::cef_app_t) -> *mut cef::_cef_browser_process_handler_t {
...
unsafe extern "C" fn get_render_process_handler(self_:
                                                                                   *mut cef::_cef_app_t)
                                                              ->
